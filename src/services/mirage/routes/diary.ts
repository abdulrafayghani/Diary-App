...
//     } catch(error) {
//         handleErrors(error, 'Failed to update Diary.')
//     }
// };
...
//     } catch (error) {
//         handleErrors(error, 'Could not get user diaries.')
//     }
// }
...
//         }
//     } catch (error) {
//         handleErrors(error, 'Failed to save entry.')
//     }
// }
...
//     } catch (error) {
//         handleErrors(error, 'Failed to update entry.')
//     }
//   }
